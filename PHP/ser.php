  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
   ...
   <div class="collapse navbar-collapse" id="navbar">
     <ul class="navbar-nav ml-auto">
       ...
       <li class="nav-item mr-2"><a href="#" class="nav-link btn btn-outline-warning">Team</a></li>
...
<!-- <div class="container">
 ...
 <input type="text" placeholder="Enter player name " name="id1" style="width:700px;height:35px;border: 2px solid red;align:center;border-radius: 4px;">
...
<div class="container cv">
  ...
  <tbody>
    ...
    $y=$_SESSION['name1'];
    $query="SELECT * FROM $entry_database where name='$y';";
    $query_run=mysqli_query($connection,$query);
    while($row=mysqli_fetch_assoc($query_run)) {
      ?>
    <tr>
